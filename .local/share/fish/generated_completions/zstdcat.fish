...
complete -c zstdcat -o 'T#' -l threads --description 'Compress using # threads (default: 1).'
complete -c zstdcat -s D --description 'use file as Dictionary to compress or decompress FILE(s) .'
complete -c zstdcat -l nodictID --description 'do not store dictionary ID within frame header (dictionary compression).'
