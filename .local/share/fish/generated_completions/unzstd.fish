...
complete -c unzstd -o 'T#' -l threads --description 'Compress using # threads (default: 1).'
complete -c unzstd -s D --description 'use file as Dictionary to compress or decompress FILE(s) .'
complete -c unzstd -l nodictID --description 'do not store dictionary ID within frame header (dictionary compression).'
